...
export const Footer = () => (
    <footer>
            ...
            <div className={s.category}>
                <h3 className={s.title}>Каталог</h3>
                <ul className={s.categoryList}>
                    <li>
                        <h4 className={s.categorySubtitle}>Женщины</h4>
                        <ul className={s.categorySublist}>
                            <li><a href="" className={s.link}>Бюстгальтеры</a></li>
                            <li><a href="" className={s.link}>Трусы</a></li>
                            <li><a href="" className={s.link}>Носки</a></li>
                            <li><a href="" className={s.link}>Халаты</a></li>
                            <li><a href="" className={s.link}>Термобелье</a></li>
                            <li><a href="" className={s.link}>Пижамы</a></li>
                        </ul>
                    </li>
                    <li>
                        <h4 className={s.categorySubtitle}>Мужчины</h4>
                        <ul className={s.categorySublist}>
                        <li><a href="" className={s.link}>Трусы</a></li>
                            <li><a href="" className={s.link}>Носки</a></li>
                            <li><a href="" className={s.link}>Халаты</a></li>
            ...
            <div className={s.contacts}>
                <a href="" className={s.link}>Inspired@gmail.com</a>
                <a href="" className={s.link}>8 930 490 26 20</a>
            </div>
            ...
            <div className={s.development}>
                <ul className={s.developmentList}>
                    <li><a href="" className={s.link}>Designer: Anastasia Ilina</a></li>
                    <li><a href="" className={s.link}>Developer: Elena Kuznetsova</a></li>
                </ul>
            </div>
        </Container>
    </footer>
